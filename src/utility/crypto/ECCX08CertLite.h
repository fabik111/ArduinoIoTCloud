...
#ifndef _ECCX08_CERT_LITE_H_
#define _ECCC08_CERT_LITE_H_
...
class ECCX08CertClass {
  ...
  private:
    ...
    byte _authorityKeyIdentifier[AUTHORITY_KEY_IDENTIFIER_LENGTH];
    byte _serialNumber[SERIAL_NUMBER_LENGTH];
    int _dates[5];
