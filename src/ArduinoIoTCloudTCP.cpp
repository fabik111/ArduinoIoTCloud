...
void ArduinoIoTCloudTCP::update()
{
   ...
   */
  if(_configurator != nullptr && _state > State::Init && _configurator->poll() == NetworkConfiguratorStates::UPDATING_CONFIG){
...
ArduinoIoTCloudTCP::State ArduinoIoTCloudTCP::handle_ConfigPhy()
{
  ...
  if(_configurator->poll() == NetworkConfiguratorStates::CONFIGURED) {
