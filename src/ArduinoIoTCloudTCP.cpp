...
int ArduinoIoTCloudTCP::begin(NetworkConfiguratorClass & configurator, ConnectionHandler & connection, bool const enable_watchdog, String brokerAddress, uint16_t brokerPort)
{
